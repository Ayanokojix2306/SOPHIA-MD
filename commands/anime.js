...
const animeCommand = {
  fullCommand: `${config.HANDLER}anime`, // Add this line
    name: 'anime',
    description: 'Fetches information about a specified anime title from the Jikan API. Example usage: .anime Naruto',
    execute: handleAnimeCommand // Update this to use the correct function
};
